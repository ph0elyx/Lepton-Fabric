...
public class LeptonBlocks {
    ...
    public static void RegisterLeptonBlocks() {
        ...
        WHITE_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.WHITE_CONCRETE)), "white_concrete_stair", "white_concrete");
        ORANGE_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.ORANGE_CONCRETE)), "orange_concrete_stair", "orange_concrete");
        MAGENTA_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.MAGENTA_CONCRETE)), "magenta_concrete_stair", "magenta_concrete");
        LIGHT_BLUE_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_BLUE_CONCRETE)), "light_blue_concrete_stair", "light_blue_concrete");
        YELLOW_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.YELLOW_CONCRETE)), "yellow_concrete_stair", "yellow_concrete");
        LIME_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.LIME_CONCRETE)), "lime_concrete_stair", "lime_concrete");
        PINK_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.PINK_CONCRETE)), "pink_concrete_stair", "pink_concrete");
        GRAY_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.GRAY_CONCRETE)), "gray_concrete_stair", "gray_concrete");
        LIGHT_GRAY_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_GRAY_CONCRETE)), "light_gray_concrete_stair", "light_gray_concrete");
        CYAN_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.CYAN_CONCRETE)), "cyan_concrete_stair", "cyan_concrete");
        PURPLE_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.PURPLE_CONCRETE)), "purple_concrete_stair", "purple_concrete");
        BLUE_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.BLUE_CONCRETE)), "blue_concrete_stair", "blue_concrete");
        BROWN_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.BROWN_CONCRETE)), "brown_concrete_stair", "brown_concrete");
        GREEN_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.GREEN_CONCRETE)), "green_concrete_stair", "green_concrete");
        RED_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.RED_CONCRETE)), "red_concrete_stair", "red_concrete");
        BLACK_CONCRETE_STAIR = generator.block.registerConcreteSlabBlock(new LeptonStairsBlock(FabricBlockSettings.copyOf(Blocks.BLACK_CONCRETE)), "black_concrete_stair", "black_concrete");
