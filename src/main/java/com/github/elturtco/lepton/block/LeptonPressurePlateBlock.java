...
public class LeptonPressurePlateBlock extends AbstractPressurePlateBlock{

    public static final BooleanProperty POWERED;
    private final LeptonPressurePlateBlock.ActivationRule type;

    public LeptonPressurePlateBlock(LeptonPressurePlateBlock.ActivationRule type, Settings settings) {
        super(settings);
